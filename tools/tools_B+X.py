...
def mv_voc07_2coco(voc07_src,cocovoc):
    ...
    -ann_dic['images'][i]['filename'].split('/')[-1] 得到 2008_000008
    """
...
def mkdir():
    ...
    if not os.path.exists('data/cocovoc'):
        os.system('mkdir data/cocovoc')
        os.system('mkdir data/cocovoc/annotations')
        os.system('mkdir data/cocovoc/train2017')
        os.system('mkdir data/cocovoc/val2017')
...
def main():
    ...
    usage:
        python tools/tools_B+X.py --coco_src /data1/renyu/data/coco --voc07_src /data1/renyu/data/VOCdevkit --voc12_src /data1/renyu/data/VOCdevkit --cocovoc data/cocovoc
    """
